            ...
            {SOLUTIONS_LIST.map((solution) => (
              ...
              >
                <div className="relative w-full h-full transition-transform duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                  <div className="absolute inset-0 [backface-visibility:hidden] bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-xs flex flex-col items-center justify-center text-center">
                  ...
                  <div className="absolute inset-0 [backface-visibility:hidden] [transform:rotateY(180deg)] bg-[#0B5198] p-6 rounded-2xl shadow-lg flex flex-col items-center justify-center text-center">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800/80 shadow-md overflow-hidden grid grid-cols-1 lg:grid-cols-12 items-center gsap-reveal">
            <div className="lg:col-span-7 p-8 sm:p-12 space-y-6">
              ...
              <ul className="space-y-3 text-sm text-slate-700 dark:text-slate-200 font-medium">
                ...
                <li className="flex items-center gap-2.5">
                  <CheckCircle className="w-5 h-5 text-emerald-500 shrink-0" />
                  <span>{t('bannerPoint2')}</span>
                </li>
                <li className="flex items-center gap-2.5">
                  <CheckCircle className="w-5 h-5 text-emerald-500 shrink-0" />
                  <span>{t('bannerPoint3')}</span>
                </li>
              </ul>
